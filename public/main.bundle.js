...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            providers: [validate_service_1.ValidateService, auth_service_1.AuthService, auth_guard_1.AuthGuard, modal_service_1.ModalService],
            ...
            animations: [
                ...
                animations_1.trigger('swipe', [
                    animations_1.transition('void => *', [
                        animations_1.style({ transform: 'translateY(-110%)' }),
                        animations_1.animate('200ms ease')
                    ]),
                    animations_1.transition('* => void', [
                        animations_1.animate('200ms ease', animations_1.style({ transform: 'translateY(-110%)' }))
                    ])
                ]),
