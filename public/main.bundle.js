...
module.exports = "<div class=\"layoutWrapper\">\r\n    <app-navbar class=\"navbarContainer\" id=\"navbarContainer\"></app-navbar>\r\n    <div class=\"bodyContainer\">\r\n      <flash-messages></flash-messages>\r\n      <router-outlet></router-outlet>\r\n    </div>\r\n    <app-modal></app-modal>\r\n</div>\r\n"
...
var AppComponent = (function () {
    function AppComponent() {
        ...
        this.minScrollDistance = 150; // How far the user has to scroll before the menu hides
    }
    AppComponent.prototype.ngOnInit = function () {
        ...
        window.onscroll = function () {
            ...
            if (prevScrollpos > currentScrollPos) {
                ...
                _this.scrollDownStarted = false;
                _this.scrollDownInitialValue = 0;
            }
            else {
                if (_this.scrollDownStarted) {
                    if (currentScrollPos > _this.scrollDownInitialValue + _this.minScrollDistance) {
                        document.getElementById("navbarContainer").style.top = "-100px";
                    }
                }
                else {
                    _this.scrollDownInitialValue = currentScrollPos;
                    _this.scrollDownStarted = true;
                }
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_photography_photography_component__ = __webpack_require__("../../../../../src/app/components/photography/photography.component.ts");
    ...
    NavbarComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            animations: [
                ...
                //   ])
                // ])
                Object(__WEBPACK_IMPORTED_MODULE_4__angular_animations__["i" /* trigger */])('swipe', [
                    Object(__WEBPACK_IMPORTED_MODULE_4__angular_animations__["h" /* transition */])('void => *', [
                        Object(__WEBPACK_IMPORTED_MODULE_4__angular_animations__["g" /* style */])({ transform: 'translateY(-110%)' }),
                        Object(__WEBPACK_IMPORTED_MODULE_4__angular_animations__["e" /* animate */])('200ms ease')
                    ]),
                    Object(__WEBPACK_IMPORTED_MODULE_4__angular_animations__["h" /* transition */])('* => void', [
                        Object(__WEBPACK_IMPORTED_MODULE_4__angular_animations__["e" /* animate */])('200ms ease', Object(__WEBPACK_IMPORTED_MODULE_4__angular_animations__["g" /* style */])({ transform: 'translateY(-110%)' }))
                    ])
                ]),
                Object(__WEBPACK_IMPORTED_MODULE_4__angular_animations__["i" /* trigger */])('fade', [
                    Object(__WEBPACK_IMPORTED_MODULE_4__angular_animations__["h" /* transition */])('void <=> *', [
                        ...
                        Object(__WEBPACK_IMPORTED_MODULE_4__angular_animations__["e" /* animate */])(800)
                    ])
                ])
            ]
        }),
...
module.exports = "<div class=\"travelSiteWrapper\">\r\n\r\n    <div class=\"contentArea animated slideInLeft \">\r\n\r\n        <h2 class=\"contentAreaHeader animated fadeIn delay-600ms\">Articles</h2>\r\n\r\n        <div class=\"article animated fadeIn delay-800ms\">\r\n            <h3>Trip to Asia</h3>\r\n            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium aspernatur exercitationem a doloremque voluptatibus officiis molestiae id repudiandae! Consequuntur hic corrupti sapiente fuga iste eligendi accusamus laborum quae beatae vero.\r\n        </div>\r\n\r\n        <div class=\"article animated fadeIn delay-1000ms\">\r\n            <h3>Trip to Europe</h3>\r\n            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium aspernatur exercitationem a doloremque voluptatibus officiis molestiae id repudiandae! Consequuntur hic corrupti sapiente fuga iste eligendi accusamus laborum quae beatae vero.\r\n        </div>\r\n\r\n        <div class=\"article animated fadeIn delay-1200ms\">\r\n            <h3>Trip to Africa</h3>\r\n            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium aspernatur exercitationem a doloremque voluptatibus officiis molestiae id repudiandae! Consequuntur hic corrupti sapiente fuga iste eligendi accusamus laborum quae beatae vero.\r\n            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium aspernatur exercitationem a doloremque voluptatibus officiis molestiae id repudiandae! Consequuntur hic corrupti sapiente fuga iste eligendi accusamus laborum quae beatae vero.\r\n            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium aspernatur exercitationem a doloremque voluptatibus officiis molestiae id repudiandae! Consequuntur hic corrupti sapiente fuga iste eligendi accusamus laborum quae beatae vero.\r\n            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium aspernatur exercitationem a doloremque voluptatibus officiis molestiae id repudiandae! Consequuntur hic corrupti sapiente fuga iste eligendi accusamus laborum quae beatae vero.\r\n        </div>\r\n\r\n    </div>\r\n    <div class=\"timelineArea animated slideInRight\">\r\n        <h2 class=\"timelineHeader\">Timeline</h2>\r\n        \r\n    </div>\r\n    \r\n</div>"
